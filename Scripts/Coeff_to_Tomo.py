...
if __name__ == '__main__':
  ...
  image = 0
  plot_emissivity(emissivities[image]) # Plot the emissivity profile for the first time instant
  plt.plot(emissivities[image, :, 0], color='b')
  plt.plot(np.linspace(0, -110, 110), emissivities[image, :, 180], color='b')
  plt.plot(emissivities[image, :, 90], color='g')
  plt.plot(np.linspace(0, -110, 110), emissivities[image, :, 270], color='g')
  plt.show()