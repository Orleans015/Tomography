...
class TomographyDataModule(L.LightningDataModule):
  ...
  def setup(self, stage=None):
    ...
    entire_dataset.data[mask_pos] = entire_dataset.data[mask_pos] - np.min(entire_dataset.data[mask_pos]) / (np.max(entire_dataset.data[mask_pos]) - np.min(entire_dataset.data[mask_pos])) 
